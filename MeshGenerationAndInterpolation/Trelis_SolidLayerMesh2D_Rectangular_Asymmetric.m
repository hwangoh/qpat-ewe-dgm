function Trelis_SolidLayerMesh2D_Rectangular_Asymmetric(GenerateDataMesh,GenerateInverseMesh,GenerateAccurateMesh,OuterSoftTissue,SkullLayer,InnerSoftTissue)
...
%=========================================================================%
%=== Creating Skin Layer ===%
fprintf(fidout,'%s\n',sprintf('create brick width 0.015 depth 0.015 height 0.015'));
fprintf(fidout,'%s\n',sprintf('volume 2 move 0.0012 0.0012 0'));
...
fprintf(fidout,'%s\n',sprintf('create brick width 0.010 depth 0.010 height 0.010'));
fprintf(fidout,'%s\n',sprintf('volume 5 move 0.0008 0.0008 0'));
...
if GenerateDataMesh == 1
%     fprintf(fidout,'%s\n',sprintf('export Abaqus "D:/Dropbox/Work/PhD/PhD_Stuff/Codes/QPAT_EWE_DGM2D_Codes_Hwan/MeshGenerationAndInterpolation/Trelis_QPATMesh_Data.inp" dimension 2 block all overwrite'));
...
if GenerateInverseMesh == 1
%     fprintf(fidout,'%s\n',sprintf('export Abaqus "D:/Dropbox/Work/PhD/PhD_Stuff/Codes/QPAT_EWE_DGM2D_Codes_Hwan/MeshGenerationAndInterpolation/Trelis_QPATMesh_Inverse.inp" dimension 2 block all overwrite'));
...
if GenerateAccurateMesh == 1
%     fprintf(fidout,'%s\n',sprintf('export Abaqus "D:/Dropbox/Work/PhD/PhD_Stuff/Codes/QPAT_EWE_DGM2D_Codes_Hwan/MeshGenerationAndInterpolation/Trelis_QPATMesh_Accurate.inp" dimension 2 block all overwrite'));
