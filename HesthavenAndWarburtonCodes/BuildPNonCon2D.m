function [pinfo,x,y,Np] = BuildPNonCon2D(K,VX,VY,EToV,Norder,pBCType,TopBndInfo,LeftBndInfo,RightBndInfo,BttmBndInfo)
...
for N=1:Nmax
    ...
    if(K>0)
        ...
        [mapO,mapD,mapN,vmapO,vmapD,vmapN] = BuildBCMaps2D(BCType,Nfp,vmapM);
        %%%%%%%%%%%%%%%
        % rewrite this part
        % inlet
        %    pinfo(N).mapI = mapI;
